...
These tools allow us to further explore which features are importance for two models and how consistent the interpretations are across local and global perspectives. By perform the comparison between the result of two models, we can also gain information about the accuracy and difference about the two models.
