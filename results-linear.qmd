...
before the modelling process, install all packages and load the dataset.
...
- 0.7234 \cdot \text{category\_count}
+ 1.6193 \cdot \text{clicked\_ad}
+ 0.5856 \cdot \text{items\_in\_cart}
+ 0.0721 \cdot \text{device\_type}_{\text{mobile}}
+ 0.7629 \cdot \text{previous\_purchases}
\end{equation}
